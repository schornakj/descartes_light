...
public:
  ...
  void addCallback(std::function<void(const std::vector<FloatType>&, const bool&)> cb);
...
private:
  ...
  std::vector<std::function<void(const std::vector<FloatType>&, const bool&)>> callbacks_;
};
